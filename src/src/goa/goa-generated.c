...
goa_object_proxy_class_init (GoaObjectProxyClass *klass)
{
  ...
  g_object_class_override_property (gobject_class, 12, "photos");
  g_object_class_override_property (gobject_class, 13, "files");
  g_object_class_override_property (gobject_class, 14, "exchange");
  g_object_class_override_property (gobject_class, 15, "media-server");
  g_object_class_override_property (gobject_class, 16, "ticketing");
  g_object_class_override_property (gobject_class, 17, "read-later");
  g_object_class_override_property (gobject_class, 18, "printers");
}
