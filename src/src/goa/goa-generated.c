...
static const _ExtendedGDBusPropertyInfo * const _goa_account_property_info_pointers[] =
{
  ...
  &_goa_account_property_info_is_locked,
  ...
  &_goa_account_property_info_maps_disabled,
  &_goa_account_property_info_music_disabled,
  &_goa_account_property_info_printers_disabled,
  &_goa_account_property_info_photos_disabled,
  &_goa_account_property_info_files_disabled,
  &_goa_account_property_info_ticketing_disabled,
  &_goa_account_property_info_read_later_disabled,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _goa_calendar_property_info_pointers[] =
{
  &_goa_calendar_property_info_accept_ssl_errors,
  &_goa_calendar_property_info_uri,
  NULL
};
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  GVariant *variant;
  g_assert (prop_id != 0 && prop_id - 1 < 2);
  info = _goa_calendar_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _goa_calendar_schedule_emit_changed (skeleton, _goa_calendar_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
static const _ExtendedGDBusPropertyInfo * const _goa_contacts_property_info_pointers[] =
{
  &_goa_contacts_property_info_accept_ssl_errors,
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  GVariant *variant;
  g_assert (prop_id != 0 && prop_id - 1 < 2);
  info = _goa_contacts_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _goa_contacts_schedule_emit_changed (skeleton, _goa_contacts_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
static const _ExtendedGDBusPropertyInfo * const _goa_files_property_info_pointers[] =
{
  &_goa_files_property_info_accept_ssl_errors,
  &_goa_files_property_info_uri,
  NULL
};
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  GVariant *variant;
  g_assert (prop_id != 0 && prop_id - 1 < 2);
  info = _goa_files_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _goa_files_schedule_emit_changed (skeleton, _goa_files_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
{
  &_goa_exchange_property_info_accept_ssl_errors,
...
static const _ExtendedGDBusPropertyInfo * const _goa_media_server_property_info_pointers[] =
{
  &_goa_media_server_property_info_dlna_supported,
  &_goa_media_server_property_info_udn,
  NULL
};
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  GVariant *variant;
  g_assert (prop_id != 0 && prop_id - 1 < 2);
  info = _goa_media_server_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _goa_media_server_schedule_emit_changed (skeleton, _goa_media_server_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
static const _ExtendedGDBusPropertyInfo * const _goa_ticketing_property_info_pointers[] =
{
  &_goa_ticketing_property_info_details,
  NULL
};
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _goa_ticketing_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _goa_ticketing_schedule_emit_changed (skeleton, _goa_ticketing_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
goa_object_default_init (GoaObjectIface *iface)
{
   ...
   * Since: 3.12.0
   */
  g_object_interface_install_property (iface, g_param_spec_object ("read-later", "read-later", "read-later", GOA_TYPE_READ_LATER, G_PARAM_READWRITE|G_PARAM_STATIC_STRINGS));
 ...
 *
 * Returns: (transfer full): A #GoaMaps that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.14.0
 */
 ...
 *
 * Returns: (transfer full): A #GoaMusic that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.18.0
 */
 ...
 *
 * Returns: (transfer full): A #GoaPhotos that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.8.0
 */
 ...
 *
 * Returns: (transfer full): A #GoaFiles that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.8.0
 */
 ...
 *
 * Returns: (transfer full): A #GoaMediaServer that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.14
 */
 ...
 *
 * Returns: (transfer full): A #GoaReadLater that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.12.0
 */
 ...
 *
 * Returns: (transfer full): A #GoaPrinters that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 *
 * Since: 3.12.0
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaMaps or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.14.0
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaMusic or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.18.0
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaPhotos or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.8.0
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaFiles or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.8.0
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaMediaServer or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.14
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaReadLater or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.12.0
 */
 ...
 * <warning>It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.</warning>
 *
 * Returns: (transfer none): A #GoaPrinters or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 *
 * Since: 3.12.0
 */
...
goa_object_proxy_class_init (GoaObjectProxyClass *klass)
{
  ...
  g_object_class_override_property (gobject_class, 18, "read-later");
  g_object_class_override_property (gobject_class, 19, "printers");
}
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaMaps or %NULL to clear the interface.
 *
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaMusic or %NULL to clear the interface.
 *
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaPhotos or %NULL to clear the interface.
 *
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaFiles or %NULL to clear the interface.
 *
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaMediaServer or %NULL to clear the interface.
 *
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaReadLater or %NULL to clear the interface.
 *
 ...
 * @object: A #GoaObjectSkeleton.
 * @interface_: (allow-none): A #GoaPrinters or %NULL to clear the interface.
 *
